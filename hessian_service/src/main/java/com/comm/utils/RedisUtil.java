...
public class RedisUtil {
	 ...
	 */
	/*
	 * public boolean isNotField(String key, String field) { try { shardedJedis
	 * = pool.getResource(); boolean bool = shardedJedis.sismember(key, field);
	 * pool.returnResource(shardedJedis); return bool; } catch (Exception e) {
	 * e.printStackTrace(); if (shardedJedis != null) {
	 * pool.returnBrokenResource(shardedJedis); } throw new JedisException(e); }
	 * }
	 */
